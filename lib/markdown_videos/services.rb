module MarkdownVideos
  ...
  SERVICES = {
    ...
    youtube: {
      ...
      markup: '<iframe width="560" height="315" title="%s" src="%s" frameborder="0" allowfullscreen></iframe>',
    ...
    vimeo: {
      ...
      markup: '<iframe title="%s" src="%s" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>',
